...
$(document).ready(function() {const app = new App();});
    ...
    return `<div id="login">
      <div class="loginchild">
          ...
          <div id="mainButton" class="mainButton">
        	  <div class="btn-text" id="openFormE" onclick="window.location='/app.html#'">English</div>
          </div>
          <div class="mainButton">
            	<div class="btn-text" id="openFormF" onclick="window.location='/app.html#fr'">Français</div>
          </div>
