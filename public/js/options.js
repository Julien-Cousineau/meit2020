...
charts:[
  ...
  emissions: [
  {id:'nox',keyword:'nox',checked:true,unit:"weight"}, 
  {id:'sox',keyword: 'sox',checked:true,unit:"weight"}, 
  {id:'co',keyword:'co',checked:true,unit:"weight"},
  {id:'hc',keyword:'hc',checked:true,unit:"weight"}, 
  {id:'nh3',keyword:'nh3',checked:true,unit:"weight"},
  {id:'pm',keyword: 'pm',checked:true,unit:"weight"},
  {id:'pm10',keyword: 'pm10',checked:true,unit:"weight"}, 
  {id:'pm25',keyword: 'pm25',checked:true,unit:"weight"},
  {id:'bc',keyword: 'bc',checked:true,unit:"weight"},
  {id:'co2',keyword:'co2',checked:true,unit:"weight"}, 
  {id:'ch4',keyword: 'ch4',checked:true,unit:"weight"}, 
  {id:'n2o',keyword: 'n2o',checked:true,unit:"weight"},
  {id:'co2e',keyword: 'co2e',checked:true,unit:"weight"},
  {id:'fuel_cons',keyword: 'fuel_cons',checked:true,unit:"weight"},
  {id:'voc',keyword: 'voc',checked:true,unit:"weight"},
  ],
  semissions: [
  {id:'inst_ph',keyword:'inst_ph',checked:true,unit:"unitless"}, 
  {id:'pahphe',keyword: 'pahphe',checked:true,unit:"weight2"}, 
  {id:'ntu',keyword:'ntu',checked:true,unit:"unitless"},
  {id:'nitrates',keyword:'nitrates',checked:true,unit:"weight2"}, 
  {id:'vanadium',keyword:'vanadium',checked:true,unit:"weight2"},
  {id:'nickle',keyword: 'nickle',checked:true,unit:"weight2"},
  {id:'copper',keyword: 'copper',checked:true,unit:"weight2"},
  {id:'cadmium',keyword: 'cadmium',checked:true,unit:"weight2"},
  {id:'mercury',keyword: 'mercury',checked:true,unit:"weight2"},
  {id:'llead',keyword: 'llead',checked:true,unit:"weight2"},
  {id:'tonnes',keyword: 'tonnes',checked:true,unit:"weight3"},
  ],
  units:{
    weight:[
    ...
    weight3:[
      ...
      {id:'t',keyword:'micrograms',divider:1,"default":true},
