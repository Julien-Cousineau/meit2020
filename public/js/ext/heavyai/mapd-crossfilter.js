(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["crossfilter"] = factory();
	else
		root["crossfilter"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _binning = __webpack_require__(103);
	...
	function uncast(string) {
	  var matching = string.match(/^CAST\([a-z,_]{0,250}/);
	  if (matching) {
	...
	(function (exports) {
	  ...
	  function resultCache(con) {
	    var resultCache = {
	      ...
	      setMaxCacheSize: function setMaxCacheSize(size) {
	        maxCacheSize = size;
	      },
	      setDataConnector: function setDataConnector(con) {
	        _dataConnector = con;
	      },
	      peekAtCache: function peekAtCache() {
	        return { cache: cache, emptyCache: emptyCache };
	      }, // TODO 4 test
	      getMaxCacheSize: function getMaxCacheSize() {
	        return maxCacheSize;
	      }, // TODO test only
	      getDataConnector: function getDataConnector() {
	  ...
	  function crossfilter() {
	    ...
	    function dimension(expression, isGlobal) {
	      ...
	      function filterExact(value, append, inverseFilter) {
	        var binParams = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];
	      ...
	      function filterRange(range) {
	        var append = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
	        var resetRange = arguments[2];
	        var inverseFilters = arguments[3];
	        var binParams = arguments[4];
	        var isRelative = arguments[5];
	      ...
	      function topAsync(k, offset, renderSpec) {
	        return new Promise(function (resolve, reject) {
	          top(k, offset, renderSpec, function (error, result) {
	            if (error) {
	              reject(error);
	            } else {
	              resolve(result);
	      ...
	      function group() {
	        var group = {
	          ...
	          getCrossfilterId: crossfilter.getId,
	          getTable: crossfilter.getTable,
	          setTargetSlot: function setTargetSlot(s) {
	            targetSlot = s;
	          }, // TODO should it return group?
	          getTargetSlot: function getTargetSlot() {
	            return targetSlot;
	          },
	          size: size,
	          sizeAsync: sizeAsync,
	        ...
	        function getBinnedDimExpression(expression, binBounds, numBins, timeBin, extract) {
	          ...
	          if (isDate) {
	            ...
	            var _binnedExpression = "cast(" + "(cast(" + expression + " as float) - " + binBounds[0] + ") * " + binsPerUnit + " as int)";
	            return _binnedExpression;
	          }
	        }
	          ...
	          if (numDimensions == 1 && numTimeDims == 1) {
	            ...
	            for (var r = 0; r < numResults; r++) {
	              ...
	              if (lastResult) {
	                ...
	                var currentTime = (0, _moment2.default)(result.key0).utc().toDate();
	                var nextTimeInterval = (0, _moment2.default)(lastTime).utc().add(incrementBy, actualTimeBinUnit).toDate();
	                ...
	                while (nextTimeInterval < currentTime) {
	                  ...
	                  nextTimeInterval = (0, _moment2.default)(nextTimeInterval).utc().add(incrementBy, actualTimeBinUnit).toDate();
	                }
	              } else {
	            ...
	            if (allDimsBinned) {
	              ...
	              var counters = Array.apply(null, Array(numDimensions)).map(Number.prototype.valueOf, 0);
	        ...
	        function all(callback) {
	          ...
	          var postProcessors = [function unBinResultsForAll(results) {
	            if (queryBinParams) {
	              var filledResults = fillBins(queryBinParams, results);
	              return (0, _binning.unBinResults)(queryBinParams, filledResults);
	            } else {
	              return results;
	            }
	          }];
	        ...
	        function minMaxWithFilters() {
	          var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	              _ref$min = _ref.min,
	              min = _ref$min === undefined ? "min_val" : _ref$min,
	              _ref$max = _ref.max,
	              max = _ref$max === undefined ? "max_val" : _ref$max;
	          ...
	          return new Promise(function (resolve, reject) {
	            cache.queryAsync(query, options, function (error, val) {
	              if (error) {
	                reject(error);
	              } else {
	                resolve(val);
	        ...
	        function top(k, offset, renderSpec, callback, ignoreFilters) {
	          ...
	          var postProcessors = [function unBinResultsForTop(results) {
	            if (queryBinParams) {
	              return (0, _binning.unBinResults)(queryBinParams, results);
	            } else {
	              return results;
	            }
	          }];
	        ...
	        function bottom(k, offset, renderSpec, callback, ignoreFilters) {
	          ...
	          var postProcessors = [function unBinResultsForBottom(results) {
	            if (queryBinParams) {
	              return (0, _binning.unBinResults)(queryBinParams, results);
	            } else {
	              return results;
	        ...
	        function size(ignoreFilters, callback) {
	          ...
	          var stateSlice = { isMultiDim: isMultiDim, _joinStmt: _joinStmt, _tablesStmt: _tablesStmt, dimArray: dimArray };
	          var queryTask = _dataConnector.query.bind(_dataConnector);
	          var sizeAsync = (0, _group.sizeAsyncWithEffects)(queryTask, writeFilter);
	          var sizeSync = (0, _group.sizeSyncWithEffects)(queryTask, writeFilter);
	          if (callback) {
	        ...
	        function sizeAsync(ignoreFilters) {
	          return new Promise(function (resolve, reject) {
	            size(ignoreFilters, function (error, data) {
	              if (error) {
	                reject(error);
	              } else {
	                resolve(data);
	    ...
	    function groupAll() {
	      ...
	      function valueAsync() {
	        var ignoreFilters = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
	        var ignoreChartFilters = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

	        return new Promise(function (resolve, reject) {
	          value(ignoreFilters, ignoreChartFilters, function (error, result) {
	            if (error) {
	              reject(error);
	            } else {
	              resolve(result);
	      ...
	      function valuesAsync() {
	        var ignoreFilters = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
	        var ignoreChartFilters = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

	        return new Promise(function (resolve, reject) {
	          values(ignoreFilters, ignoreChartFilters, function (error, data) {
	            if (error) {
	              reject(error);
	            } else {
	              resolve(data);
	    ...
	    return arguments.length >= 2 ? setDataAsync(arguments[0], arguments[1], arguments[2]) // dataConnector, dataTable
	    : crossfilter;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function unBinResults(queryBinParams, results) {
	  ...
	  for (var b = 0; b < queryBinParams.length; b++) {
	    ...
	    var queryBinParam = queryBinParams[b];
	    var numBins = queryBinParam.numBins,
	        binBounds = queryBinParam.binBounds,
	        extract = queryBinParam.extract;

	    var keyName = "key" + b.toString();

	    if (binBounds[0] instanceof Date && binBounds[1] instanceof Date) {
	      // jscs:disable
	      var binBoundsMsMinMax = [binBounds[0].getTime(), binBounds[1].getTime()];
	      var timeBin = queryBinParam.timeBin;

	      if (extract) {
	        for (var r = 0; r < numRows; ++r) {
	          var result = results[r][keyName];
	          if (result === null) {
	            continue;
	          }
	          results[r][keyName] = [{
	        ...
	        var intervalMs = _constants.TIME_LABEL_TO_SECS[timeBin] * 1000;
	        for (var r = 0; r < numRows; ++r) {
	          var _result = results[r][keyName];
	          if (_result === null) {
	            continue;
	          }

	          // jscs:disable
	          var minValue = _result instanceof Date ? _result : new Date(binBoundsMsMinMax[0] + _result * intervalMs);
	          var min = {
	            value: minValue,
	            timeBin: timeBin,
	            isBin: true,
	          ...
	          var maxValue = new Date(minValue.getTime() + intervalMs - 1);
	          var max = {
	            value: maxValue,
	            timeBin: timeBin,
	            isBin: true,
	      ...
	      for (var r = 0; r < numRows; ++r) {
	        ...
	        var _min = results[r][keyName] * unitsPerBin + binBounds[0];
	        var _max = _min + unitsPerBin;
	        results[r][keyName] = [_min, _max];
	      }
	    }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.mapResultToArray = mapResultToArray;
	exports.sizeAsyncWithEffects = sizeAsyncWithEffects;
	exports.sizeSyncWithEffects = sizeSyncWithEffects;

	var _query = __webpack_require__(105);

	var _task = __webpack_require__(106);
	...
	/* istanbul ignore next */
	function sizeAsyncWithEffects(queryTask, writeFilter) {
	  return function sizeAsyncWithState(state, ignoreFilters, callback) {
	    var query = (0, _query.formGroupSizeQuery)(writeFilter, state, ignoreFilters);
	    var task = (0, _task.createQueryTask)(queryTask, query);
	    if (!state.multiDim) {
	      (0, _task.runQueryTask)(task, function (error, result) {
	        if (error) {
	          callback(error);
	        } else {
	...
	/* istanbul ignore next */
	function sizeSyncWithEffects(queryTask, writeFilter) {
	  return function sizeSyncWithState(state, ignoreFilters) {
	    var query = (0, _query.formGroupSizeQuery)(writeFilter, state, ignoreFilters);
	    var task = (0, _task.createQueryTask)(queryTask, query);
	    if (!state.multiDim) {
	      var result = (0, _task.runQueryTask)(task);
	      return result[0].n;
	    } else {
	      var queryResult = (0, _task.runQueryTask)(task);
